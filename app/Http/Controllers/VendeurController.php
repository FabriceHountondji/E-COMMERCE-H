...
class VendeurController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard/vendeur/index', compact('title','users'));
    }
    ...
    public function create()
    {
        ...
        $roles = Role::where('name', 'admin')
                        ->orWhere('name', 'vendeur')->get();
        return view('dashboard/vendeur/create', compact('title', 'roles'));
    }
    ...
    public function show(User $user)
    {
        ...
        return view('dashboard/vendeur/show', compact('title', 'users'));
    }
