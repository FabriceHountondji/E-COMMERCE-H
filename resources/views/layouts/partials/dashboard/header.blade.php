                ...
                <div class="widget-content p-0">
                    <div class="widget-content-wrapper">
                        <div class="widget-content-left">
                            <div class="btn-group">
                                <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="p-0 btn">
                                    ...
                                    <img width="42" class="rounded-circle" src="{{ asset(Auth::user()->photo) }}" alt="">
                                                ...
                                                <div class="widget-content p-0">
                                                    <div class="widget-content-wrapper">
                                                        ...
                                                        <div class="widget-content-left">
                                                            ...
                                                            <div class="widget-heading"> Prénom(s)-Nom </div>
                                                            <div class="widget-subheading opacity-8">Le - Rôle</div>
                        ...
                        <div class="widget-content-left  ml-3 header-user-info">
                            ...
                            <div class="widget-subheading"> {{ Auth::user()->username }}</div>
