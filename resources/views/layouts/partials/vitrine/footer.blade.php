            ...
            <div class="row">
                <div class="col-sm-4 col-sm-4 col-xs-12">
                    <div class="widget_logo">
                        <a href="#"><img src="{{ asset('storage/VITRINE/images/logo_footer.png') }}" alt="logo"></a>
                        <ul>
                            <li>
                                <div class="wl_left">
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="footer_text">
                    <p>&copy;2015 <a href="#">E-Comshop</a>. All rights reserved</p>
                </div>
            </div>
            <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="footer_right">
                    <ul>
                        <li><a href="#"><img src="{{ asset('storage/VITRINE/images/mc.png') }}" alt="" /></a></li>
                        <li><a href="#"><img src="{{ asset('storage/VITRINE/images/visa.png') }}" alt="" /></a></li>
                        <li><a href="#"><img src="{{ asset('storage/VITRINE/images/crr.png') }}" alt="" /></a></li>
                        <li><a href="#"><img src="{{ asset('storage/VITRINE/images/disco.png') }}" alt="" /></a></li>
                        <li><a href="#"><img src="{{ asset('storage/VITRINE/images/bank.png') }}" alt="" /></a></li>
                    </ul>
                </div>
            </div>
        </div>
