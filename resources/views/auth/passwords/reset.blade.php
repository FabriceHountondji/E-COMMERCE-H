...
<div class="app-main__inner">
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>Réinitialiser mot de passe
    ...
    <div class="main-card mb-3 card">
        <div class="card-body">
            <h5 class="card-title">Formulaire de réinitialisation password</h5>
            <form id="signupForm" class="col-md-10 mx-auto" method="post" action="">
                <div class="form-group">
                    <label for="email">Ancien mot de passe</label>
                    <div>
                        <input type="password" class="form-control" id="old_password" name="old_password" placeholder="Password courant" />
                    </div>
                </div>
